...
public class PaintView extends View {
    ...
    public static final int COLOR_PEN = Color.WHITE;
    public static final int COLOR_RED_PEN = Color.RED;
    public static final int COLOR_BLUE_PEN = Color.BLUE;
    public static final int COLOR_YELLOW_PEN = Color.YELLOW;
    public static final int COLOR_ERASER = Color.BLACK;
    ...
    public void redPen(){currentColor = COLOR_RED_PEN;}
    public void bluePen(){
        currentColor = COLOR_BLUE_PEN;
    }
    public void yellowPen(){
        currentColor = COLOR_YELLOW_PEN;
    }
